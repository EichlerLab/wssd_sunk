...
if __name__=="__main__":
    ...
    parser.add_argument("--fn_fa", help="reference genome fasta file")
    parser.add_argument("--GC_DTS", dest="fn_GC_DTS", help="GC tracks DTS file")
    parser.add_argument("--DTS_contigs", dest='fn_DTS_contigs', help="Contig sizes file")
    parser.add_argument("--dup_tabix", dest="fn_dup_tabix", help="Superdups tabix file")
